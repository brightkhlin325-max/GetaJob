...
/**
 * Format raw job description into structured markdown.
 */
...
4. Translate the summary to Traditional Chinese (zh-TW) if the original language is not Chinese, otherwise keep the original language tone (but headings must use the requested Traditional Chinese).
